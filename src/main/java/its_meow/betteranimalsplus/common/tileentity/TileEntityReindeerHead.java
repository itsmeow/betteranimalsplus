...
public class TileEntityReindeerHead extends TileEntityHead {
	...
	public TileEntityReindeerHead() {
		super(ModelReindeerHead.class.asSubclass(ModelBase.class), TileEntityReindeerHead.class, 0F,
				TextureRegistry.reindeer_1, TextureRegistry.reindeer_2, TextureRegistry.reindeer_3,
				TextureRegistry.reindeer_4);
	}
	...
	public ResourceLocation getTexture() {
		if(this.typeNum <= 4) {
			...
			return TileEntityReindeerHead.getEntityTexture(this.typeNum);
		}
	}
