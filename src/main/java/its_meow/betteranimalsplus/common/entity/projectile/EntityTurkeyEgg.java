...
public class EntityTurkeyEgg extends EntityModEgg {
    public static EntityType<EntityTurkeyEgg> TURKEY_EGG_TYPE = ModEntities.H.createEntityType(EntityTurkeyEgg.class, EntityTurkeyEgg::new, "turkey_egg", EntityClassification.MISC, 64, 1, true, 0.25F, 0.25F);
