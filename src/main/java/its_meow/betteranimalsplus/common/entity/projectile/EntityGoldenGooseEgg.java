...
public class EntityGoldenGooseEgg extends EntityModEgg {
    public static EntityType<EntityGoldenGooseEgg> GOLDEN_GOOSE_EGG_TYPE = ModEntities.<EntityGoldenGooseEgg>createEntityType(EntityGoldenGooseEgg.class, EntityGoldenGooseEgg::new, "golden_goose_egg", EntityClassification.MISC, 64, 1, true, 0.25F, 0.25F);
