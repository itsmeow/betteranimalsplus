...
public class EntityGooseEgg extends EntityModEgg {
    public static EntityType<EntityGooseEgg> GOOSE_EGG_TYPE = ModEntities.H.<EntityGooseEgg>createEntityType(EntityGooseEgg.class, EntityGooseEgg::new, "goose_egg", EntityClassification.MISC, 64, 1, true, 0.25F, 0.25F);
