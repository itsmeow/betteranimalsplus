...
public class EntityTypeContainerTameable<T extends MobEntity> extends EntityTypeContainer<T> {
    ...
    public static class TameableBuilder<T extends MobEntity> extends EntityTypeContainer.Builder<T> {
        ...
        public TameableBuilder<T> variants(EntityVariant... variants) {
        ...
        public EntityTypeContainerTameable<T> build() {
            return new EntityTypeContainerTameable<T>(entityClass, factory, entityName, spawnType, eggColorSolid, eggColorSpot, spawnWeight, spawnMinGroup, spawnMaxGroup, width, height, despawn, variantCount, variants, defaultTameItems, customConfig, defaultBiomeSupplier, placementType, heightMapType, placementPredicate);
        }
