...
public class EntityReindeer extends EntityAnimal implements IJumpingMount {
    ...
    {
        return this.getReindeerWatchableBoolean(2);
    }
    ...
    public void setReindeerTamed(boolean tamed)
    {
        this.setReindeerWatchableBoolean(2, tamed);
    }
    ...
    public void setReindeerSaddled(boolean saddled)
    {
        this.setReindeerWatchableBoolean(4, saddled);
    }
    ...
    public boolean isReindeerSaddled()
    {
        return this.getReindeerWatchableBoolean(4);
    }
    ...
    {
        return super.isMovementBlocked() && this.isBeingRidden() && this.isReindeerSaddled() || this.isEatingHaystack() || this.isRearing();
    }
    ...
    {
        if (this.isBeingRidden() && this.canBeSteered() && this.isReindeerSaddled())
        {
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        this.setReindeerTamed(compound.getBoolean("Tame"));
        String s;
    ...
    /**
     * Return true if the reindeer entity ready to mate. (no rider, not riding, tame, adult, not steril...)
     */
