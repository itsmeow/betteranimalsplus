...
public abstract class EntityAIMoveToNonFullBlock extends EntityAIBase {
    ...
    public EntityAIMoveToNonFullBlock(EntityCreature creature, double speedIn, int length)
    {
