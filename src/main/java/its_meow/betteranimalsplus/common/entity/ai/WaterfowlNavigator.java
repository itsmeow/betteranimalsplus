...
public class WaterfowlNavigator extends GroundPathNavigator {
    ...
    public Path func_179680_a(BlockPos pos, int p_179680_2_) {
        if(this.world.isAirBlock(pos)) {
            ...
            if(blockpos.getY() > 0) {
                return super.func_179680_a(blockpos.up(), p_179680_2_);
            }
        ...
        if(!this.world.getBlockState(pos).getMaterial().isSolid()) {
            ...
            return super.func_179680_a(blockpos1, p_179680_2_);
        }
    }

    @Override
    public Path func_75494_a(Entity entityIn, int p_75494_2_) {
        return this.func_179680_a(new BlockPos(entityIn), p_75494_2_);
    }
