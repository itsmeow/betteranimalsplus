...
public class WaterfowlNavigator extends PathNavigateGround {

    public WaterfowlNavigator(EntityLiving entitylivingIn, World worldIn) {
    ...
    private int getPathablePosY() {
        if(this.entity.isInWater() && this.getCanSwim()) {
            int i = MathHelper.floor(this.entity.getEntityBoundingBox().minY);
            ...
            while(block == Blocks.WATER) {
                ...
                ++j;
                if(j > 16) {
                    return MathHelper.floor(this.entity.getEntityBoundingBox().minY);
                }
            }

            return i;
        } else {
            return MathHelper.floor(this.entity.getEntityBoundingBox().minY + 0.5D);
        }
    }
