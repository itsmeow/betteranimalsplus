...
public class EntityTypeContainerTameable<T extends LivingEntity> extends EntityTypeContainer<T> {
    ...
    public EntityTypeContainerTameable(Class<T> EntityClass, Function<World, T> func, String entityNameIn, EntityClassification type, int solidColorIn, int spotColorIn, int prob, int min, int max, float width, float height, boolean despawn, String[] defaultTameItems, @Nullable CustomConfigurationHolder customConfig, Biome... biomes) {
        this(EntityClass, func, entityNameIn, type, solidColorIn, spotColorIn, prob, min, max, width, height, despawn, defaultTameItems, customConfig, toBiomes(biomes));
    }

    public EntityTypeContainerTameable(Class<T> EntityClass, Function<World, T> func, String entityNameIn, EntityClassification type, int solidColorIn, int spotColorIn, int prob, int min, int max, float width, float height, boolean despawn, String[] defaultTameItems, @Nullable CustomConfigurationHolder customConfig, Set<Biome> biomes) {
