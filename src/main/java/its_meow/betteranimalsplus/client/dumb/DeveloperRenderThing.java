...
public class DeveloperRenderThing {
    ...
    public static void onRenderPlayerPre(RenderPlayerEvent.Pre event) {
        if(SafeSyncThing.get(event.getPlayer().getGameProfile().getId()).on) {
            ...
            RENDER_INSTANCE.doRender(event.getPlayer(), event.getX(), event.getY(), event.getZ(), rot, event.getPartialRenderTick());
        }
    }
    ...
    public static class StupidRender extends LivingRenderer<PlayerEntity, EntityModel<PlayerEntity>> {
        ...
        public void doRender(PlayerEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
            if(SafeSyncThing.get(entity.getGameProfile().getId()).nametag) {
        ...
        @Override
        protected void renderEntityName(PlayerEntity entityIn, double x, double y, double z, String name, double distanceSq) {
