...
public class ModelLumaSlug extends Model {
    ...
    public RendererModel tentacleL;
    public RendererModel tentacleR;
    ...
    public ModelLumaSlug() {
        ...
        this.antennaL = new RendererModel(this, 18, 0);
