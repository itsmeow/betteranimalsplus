...
public class ModelReindeer extends ModelBase {
	...
	public ModelReindeer() {
		...
		this.setRotateAngle(mane02, -0.5462880558742251F, 0.0F, 0.0F);
		...
		this.setRotateAngle(mane01, -0.5462880558742251F, 0.0F, 0.0F);
		...
		this.setRotateAngle(mane04, -0.767944870877505F, 0.0F, 0.0F);
