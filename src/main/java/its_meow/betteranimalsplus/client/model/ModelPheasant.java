...
public class ModelPheasant extends ModelBase {
    ...
    public ModelPheasant() {
        ...
        this.setRotateAngle(rClaw02_1, 0.24434609527920614F, -0.3490658503988659F, 0.0F);
        ...
        this.setRotateAngle(rTailFeather04, 0.0F, -0.6283185307179586F, 0.0F);
        ...
        this.setRotateAngle(rTailFeather02, 0.0F, -0.2617993877991494F, 0.0F);
        ...
        this.setRotateAngle(lTailFeather01b, 0.08726646259971647F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(neck02, -0.03490658503988659F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(neck01, -0.9075712110370513F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(rTailFeather03, 0.0F, -0.5235987755982988F, 0.0F);
        ...
        this.setRotateAngle(rWing01, 0.0F, 1.2217304763960306F, 0.0F);
        ...
        this.setRotateAngle(tail01Feathers, 0.12217304763960307F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(lTailFeather02, 0.0F, 0.2617993877991494F, 0.0F);
        ...
        this.setRotateAngle(rClaw02, 0.24434609527920614F, 0.3490658503988659F, 0.0F);
        ...
        this.setRotateAngle(lTailFeather03, 0.0F, 0.5235987755982988F, 0.0F);
        ...
        this.setRotateAngle(lTailFeather04, 0.0F, 0.6283185307179586F, 0.0F);
        ...
        this.setRotateAngle(lWing01, 0.0F, -1.2217304763960306F, 0.0F);
        ...
        this.setRotateAngle(rTailFeather01b, 0.08726646259971647F, 0.0F, 0.0F);
