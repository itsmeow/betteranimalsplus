...
public class ModelBarracuda<T extends LivingEntity> extends EntityModel<T> {
    ...
    public RendererModel leftlowfin;
    public RendererModel rightlowfin;
    public RendererModel tail;
    public RendererModel topfin2;
    public RendererModel lowfin;
    ...
    public ModelBarracuda() {
        ...
        this.topfin2 = new RendererModel(this, 13, 115);
        ...
        this.rightlowfin = new RendererModel(this, 37, 109);
        ...
        this.snout = new RendererModel(this, 22, 85);
        ...
        this.lowfin = new RendererModel(this, 27, 115);
        ...
        this.lowerjaw = new RendererModel(this, 39, 79);
        ...
        this.leftfin1 = new RendererModel(this, 16, 112);
        ...
        this.topjaw = new RendererModel(this, 0, 81);
        ...
        this.neck = new RendererModel(this, 0, 68);
        ...
        this.topfin1 = new RendererModel(this, 0, 115);
