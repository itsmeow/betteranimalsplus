...
public class ModelLamprey<T extends LivingEntity> extends EntityModel<T> {
    ...
    public RendererModel fin01;
    public RendererModel tail02;
    public RendererModel fin02;
    public RendererModel fin03;
    ...
    public ModelLamprey() {
        ...
        this.body02 = new RendererModel(this, 0, 16);
        ...
        this.mouth = new RendererModel(this, 0, 64);
