...
public class ModelSongbird extends ModelBase {
    ...
    public ModelSongbird() {
        ...
        this.lWing03.setRotationPoint(5.0F, 0.0F, 0.0F);
        this.lWing03.addBox(0.0F, -0.5F, -0.4F, 4, 1, 2, 0.0F);
        this.setRotateAngle(lWing03, 0.0F, -0.2617993877991494F, 0.0F);
        this.lTailFeather03 = new ModelRenderer(this, -6, 37);
        this.lTailFeather03.setRotationPoint(1.1F, 1.0F, 3.5F);
        this.lTailFeather03.addBox(-1.0F, 0.0F, 0.0F, 2, 0, 9, 0.0F);
        this.setRotateAngle(lTailFeather03, 0.06981317007977318F, 0.33161255787892263F, 0.0F);
        this.crest = new ModelRenderer(this, 43, 11);
        this.crest.setRotationPoint(0.0F, -0.4F, -1.5F);
        this.crest.addBox(-2.0F, -2.5F, -1.5F, 4, 3, 6, 0.0F);
        this.setRotateAngle(crest, 0.47123889803846897F, 0.0F, 0.0F);
        this.lWing02 = new ModelRenderer(this, 0, 55);
        this.lWing02.setRotationPoint(4.0F, 0.0F, -1.1F);
        this.lWing02.addBox(0.0F, -0.5F, -0.4F, 5, 1, 2, 0.0F);
        this.setRotateAngle(lWing02, -0.3665191429188092F, -0.5235987755982988F, 0.0F);
        this.rLeg02 = new ModelRenderer(this, 34, 0);
        this.rLeg02.mirror = true;
        this.rLeg02.setRotationPoint(0.0F, 2.6F, 0.0F);
        ...
        this.lTailFeather01.setRotationPoint(0.7F, 0.7F, 5.2F);
        this.lTailFeather01.addBox(-1.0F, 0.0F, 0.0F, 2, 0, 9, 0.0F);
        ...
        this.beak01.addBox(-1.0F, -0.9F, -2.3F, 2, 1, 4, 0.0F);
        ...
        this.rWingFeather02.addBox(-2.5F, 0.0F, 0.0F, 5, 0, 8, 0.0F);
        this.rTailFeather03 = new ModelRenderer(this, -6, 37);
        this.rTailFeather03.mirror = true;
        this.rTailFeather03.setRotationPoint(-1.1F, 1.0F, 3.5F);
        this.rTailFeather03.addBox(-1.0F, 0.0F, 0.0F, 2, 0, 9, 0.0F);
        this.setRotateAngle(rTailFeather03, 0.06981317007977318F, -0.33161255787892263F, 0.0F);
        this.lWingFeather01 = new ModelRenderer(this, 17, 30);
        this.lWingFeather01.setRotationPoint(1.8F, 0.0F, 0.5F);
        this.lWingFeather01.addBox(-2.0F, 0.0F, 0.0F, 4, 0, 7, 0.0F);
        ...
        this.neck.addBox(-2.0F, -2.0F, -3.8F, 4, 4, 3, 0.0F);
        ...
        this.rWing02.addBox(-5.0F, -0.5F, -0.4F, 5, 1, 2, 0.0F);
        ...
        this.rTailFeather01.setRotationPoint(-0.7F, 0.7F, 5.2F);
        this.rTailFeather01.addBox(-1.0F, 0.0F, 0.0F, 2, 0, 9, 0.0F);
        ...
        this.beak02.addBox(-0.1F, -0.5F, -2.6F, 1, 1, 3, 0.0F);
        ...
        this.rWingFeather01.addBox(-2.0F, 0.0F, 0.0F, 4, 0, 7, 0.0F);
        ...
        this.rWingFeather03.addBox(-9.0F, 0.0F, -1.4F, 11, 0, 10, 0.0F);
        this.lWingFeather03 = new ModelRenderer(this, 15, 47);
        this.lWingFeather03.setRotationPoint(1.8F, 0.0F, 1.0F);
        this.lWingFeather03.addBox(-2.0F, 0.0F, -1.4F, 11, 0, 10, 0.0F);
        this.rLeg01 = new ModelRenderer(this, 24, 0);
        this.rLeg01.mirror = true;
        this.rLeg01.setRotationPoint(-1.7F, 2.5F, 2.2F);
        this.rLeg01.addBox(-1.0F, -0.2F, -1.0F, 2, 3, 2, 0.0F);
        this.setRotateAngle(rLeg01, 0.2617993877991494F, 0.0F, 0.0F);
        this.rFoot = new ModelRenderer(this, 39, 0);
        this.rFoot.mirror = true;
        this.rFoot.setRotationPoint(0.0F, 2.9F, 0.0F);
        this.rFoot.addBox(-0.51F, -0.2F, -2.5F, 1, 1, 3, 0.0F);
        this.setRotateAngle(rFoot, 0.19198621771937624F, 0.05235987755982988F, 0.0F);
        this.tailBase = new ModelRenderer(this, 0, 16);
        this.tailBase.setRotationPoint(0.0F, -0.9F, 4.3F);
        this.tailBase.addBox(-2.5F, -1.5F, 0.2F, 5, 2, 6, 0.0F);
        this.setRotateAngle(tailBase, 0.10471975511965977F, 0.0F, 0.0F);
        this.head = new ModelRenderer(this, 25, 17);
        this.head.setRotationPoint(0.0F, -0.9F, -2.6F);
        this.head.addBox(-2.4F, -2.1F, -4.0F, 5, 4, 5, 0.0F);
        ...
        this.rTailFeather02.setRotationPoint(-1.4F, 0.9F, 4.4F);
        this.rTailFeather02.addBox(-1.0F, 0.0F, 0.0F, 2, 0, 9, 0.0F);
        this.setRotateAngle(rTailFeather02, 0.06981317007977318F, -0.13962634015954636F, 0.0F);
        ...
        this.tailCoverts.setRotationPoint(0.0F, -0.9F, -0.9F);
        this.tailCoverts.addBox(-2.0F, 1.5F, -0.1F, 4, 3, 6, 0.0F);
        this.setRotateAngle(tailCoverts, 0.10471975511965977F, 0.0F, 0.0F);
        this.lLeg01 = new ModelRenderer(this, 24, 0);
        this.lLeg01.setRotationPoint(1.7F, 2.5F, 2.2F);
        this.lLeg01.addBox(-1.0F, -0.2F, -1.0F, 2, 3, 2, 0.0F);
        this.setRotateAngle(lLeg01, 0.2617993877991494F, 0.0F, 0.0F);
        this.lFoot = new ModelRenderer(this, 39, 0);
        this.lFoot.setRotationPoint(0.0F, 3.2F, 0.0F);
        ...
        this.lTailFeather02.setRotationPoint(1.4F, 0.9F, 4.4F);
        this.lTailFeather02.addBox(-1.0F, 0.0F, 0.0F, 2, 0, 9, 0.0F);
        this.setRotateAngle(lTailFeather02, 0.06981317007977318F, 0.13962634015954636F, 0.0F);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (entity instanceof EntitySongbird) {
            ...
            if (bird.isFlying()) {
                ...
                this.rWing01.rotateAngleZ = MathHelper.cos(f2 * 3F) * (float) Math.PI / 5F;
                ...
                boolean flag = entity instanceof EntityLivingBase
                        && ((EntityLivingBase) entity).getTicksElytraFlying() > 4;
                float e = 1.0F;
