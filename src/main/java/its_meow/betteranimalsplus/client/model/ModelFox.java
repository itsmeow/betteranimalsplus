...
public class ModelFox extends ModelBetterAnimals {
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount,
		...
		/*
		 * if (entityfox.isSitting()) { this.neck.setRotationPoint(-1.0F, 16.0F,
		 * -3.0F); this.neck.rotateAngleX = ((float)Math.PI * 2F / 5F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		if(entity instanceof EntityFox) {
			...
			/*
			 * if(fox.isSitting()) { this.rear.rotateAngleX = -1F;
			 * this.tail01.rotateAngleX = 0F; this.body.rotateAngleX = -0.3F;
			 * }else { this.rear.rotateAngleX = 0; this.body.rotateAngleX = 0; }
			 */
