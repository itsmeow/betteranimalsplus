...
public class ModelFox extends ModelBetterAnimals {
    ...
    public ModelFox() {
        ...
        this.fur03 = new RendererModel(this, 47, 35);
        ...
        this.fur04 = new RendererModel(this, 44, 43);
        ...
        this.tail02b = new RendererModel(this, 12, 45);
        ...
        this.tail02d = new RendererModel(this, 12, 45);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        this.head.rotateAngleX = (float) Math.toRadians(ModelBetterAnimals.getHeadPitch((LivingEntity) entity))
                + 0.6f;
