...
public class LayerCoyoteEyes implements LayerRenderer<EntityCoyote>
{
	...
	public void render(EntityCoyote entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		if(!entity.isDaytime()) {
