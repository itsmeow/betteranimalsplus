...
@OnlyIn(Dist.CLIENT)
public class LayerWolfEyes<T extends LivingEntity, M extends ModelCustomWolf<T>> extends LayerRenderer<T, M> {

    public LayerWolfEyes(IEntityRenderer<T, M> p_i50921_1_) {
       super(p_i50921_1_);
    }
