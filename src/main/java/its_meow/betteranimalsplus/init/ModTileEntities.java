...
public class ModTileEntities {
     ...
     * Tile Entities
     */
	public static final TileEntityType<?> HEAD_TYPE = TileEntityType.Builder.create(TileEntityHead::new, HeadTypes.getAllBlocks()).build(null).setRegistryName(Ref.MOD_ID, "head");
