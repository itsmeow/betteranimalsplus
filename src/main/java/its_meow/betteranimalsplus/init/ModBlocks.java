...
public class ModBlocks {
    ...
    public static final BlockTurkey TURKEY_EATEN_RAW = new BlockTurkey("turkey_eaten_raw");
    public static final BlockTurkey TURKEY_EATEN_COOKED = new BlockTurkey("turkey_eaten_cooked");
    public static final BlockTurkey TURKEY_RAW = new BlockTurkey("turkey_raw", TURKEY_EATEN_RAW);
