...
public class EntityArapaima extends EntityWaterMobPathingBucketable implements IHaveHunger<EntityWaterMobPathing> {

    private int hunger = 0;

    public EntityArapaima(EntityType<? extends EntityArapaima> entityType, Level world) {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(0, new HurtByTargetGoal(this) {
            ...
            public boolean canUse() {
                return EntityArapaima.this.level.getDifficulty() != Difficulty.PEACEFUL && super.canUse();
            }
        });
        this.targetSelector.addGoal(1, new HungerNearestAttackableTargetGoal<>(this, WaterAnimal.class, 100, true, true, e -> !(e instanceof Enemy) && !(e instanceof EntityArapaima)));
        this.targetSelector.addGoal(1, new PeacefulNearestAttackableTargetGoal<>(this, Player.class, 100, true, true, EntityArapaima::isWearingShiny));
    }
    ...
    @Override
    public EntityTypeContainer<? extends EntityArapaima> getContainer() {
        return ModEntities.ARAPAIMA;
    }
    ...
    public static class RushAttackGoal extends Goal {
        ...
        protected EntityArapaima e;
        protected boolean done = false;

        public RushAttackGoal(EntityArapaima e) {
            this.e = e;
