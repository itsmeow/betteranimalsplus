...
public class EntityHoatzin extends Animal implements FlyingAnimal, IContainerEntity<EntityHoatzin> {

    protected static final EntityDataAccessor<Boolean> LANDED = SynchedEntityData.defineId(EntityHoatzin.class, EntityDataSerializers.BOOLEAN);
    ...
    public EntityHoatzin(EntityType<? extends EntityHoatzin> entityType, Level worldIn) {
    ...
    @Override
    public EntityHoatzin getImplementation() {
        return this;
    }

    @Override
    public EntityTypeContainer<EntityHoatzin> getContainer() {
        return ModEntities.HOATZIN;
    }

    public static boolean canHoatzinSpawn(EntityType<EntityHoatzin> type, ServerLevelAccessor world, MobSpawnType reason, BlockPos pos, RandomSource rand) {
