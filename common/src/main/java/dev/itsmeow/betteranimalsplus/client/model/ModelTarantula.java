 ...
 */
public class ModelTarantula<T extends LivingEntity> extends ModelBetterAnimals<T> {

    public ModelPart bodyBase;
    public ModelPart abdomen;
    public ModelPart thorax;
    public ModelPart abdomenHair01;
    public ModelPart abdomenHair02;
    ...
    public ModelTarantula() {
        this.texWidth = 64;
        this.texHeight = 64;
        this.abdomenHair01 = new ModelPart(this, 0, 55);
        this.abdomenHair01.setPos(0.0F, -2.1F, 1.5F);
        this.abdomenHair01.addBox(-3.5F, -1.0F, 0.0F, 7, 2, 5, 0.0F);
        this.setRotateAngle(this.abdomenHair01, 0.36425021489121656F, 0.0F, 0.0F);
        this.lLeg01d = new ModelPart(this, 49, 38);
        this.lLeg01d.setPos(6.7F, 0.0F, 0.0F);
        ...
        this.rLeg02d = new ModelPart(this, 49, 38);
        this.rLeg02d.mirror = true;
        this.rLeg02d.setPos(-6.7F, 0.0F, 0.0F);
        ...
        this.abdomenHair02 = new ModelPart(this, 25, 55);
        this.abdomenHair02.setPos(0.0F, -2.0F, 5.0F);
        this.abdomenHair02.addBox(-4.0F, -1.0F, 0.0F, 8, 2, 7, 0.0F);
        this.setRotateAngle(this.abdomenHair02, 0.31869712141416456F, 0.0F, 0.0F);
        this.rLeg03FurB = new ModelPart(this, 16, 49);
        this.rLeg03FurB.mirror = true;
        this.rLeg03FurB.setPos(1.0F, -0.3F, 0.2F);
        ...
        this.lLeg02FurA = new ModelPart(this, 16, 36);
        this.lLeg02FurA.setPos(2.6F, -0.2F, 0.2F);
        ...
        this.rLeg01FurA = new ModelPart(this, 0, 36);
        this.rLeg01FurA.mirror = true;
        this.rLeg01FurA.setPos(-2.6F, -0.2F, 0.2F);
        ...
        this.rLeg03a = new ModelPart(this, 41, 42);
        ...
        this.bodyBase.setPos(0.0F, 14.7F, 3.0F);
        this.bodyBase.addBox(-2.0F, -1.5F, 0.0F, 4, 3, 1, 0.0F);
        this.rLeg02FurA = new ModelPart(this, 16, 36);
        this.rLeg02FurA.mirror = true;
        this.rLeg02FurA.setPos(-2.6F, -0.2F, 0.2F);
        ...
        this.lLeg01a = new ModelPart(this, 41, 42);
        ...
        this.lLeg03FurB = new ModelPart(this, 16, 49);
        this.lLeg03FurB.setPos(1.0F, -0.3F, 0.2F);
        this.lLeg03FurB.addBox(0.0F, -0.7F, -1.5F, 4, 2, 3, 0.0F);
        this.setRotateAngle(this.lLeg03FurB, 0.0F, 0.0F, -0.4553564018453205F);
        this.rPedipalp01 = new ModelPart(this, 29, 12);
        ...
        this.lLeg03FurA = new ModelPart(this, 0, 49);
        this.lLeg03FurA.setPos(2.6F, -0.2F, 0.2F);
        ...
        this.rLeg02a = new ModelPart(this, 41, 42);
        ...
        this.lLeg04FurA = new ModelPart(this, 0, 36);
        this.lLeg04FurA.setPos(2.6F, -0.2F, 0.2F);
        ...
        this.rLeg01a = new ModelPart(this, 41, 42);
        ...
        this.lLeg03a = new ModelPart(this, 41, 42);
        ...
        this.lLeg02d = new ModelPart(this, 49, 38);
        this.lLeg02d.setPos(6.7F, 0.0F, 0.0F);
        ...
        this.lLeg01b = new ModelPart(this, 42, 26);
        ...
        this.lLeg02b = new ModelPart(this, 42, 26);
        ...
        this.rFang02 = new ModelPart(this, 58, 20);
        ...
        this.rLeg02FurB = new ModelPart(this, 16, 42);
        this.rLeg02FurB.mirror = true;
        this.rLeg02FurB.setPos(-1.0F, -0.3F, 0.2F);
        ...
        this.head.setPos(0.0F, -0.1F, -7.2F);
        this.head.addBox(-3.5F, -3.0F, -3.0F, 7, 5, 6, 0.0F);
        this.rLeg04c = new ModelPart(this, 43, 32);
        this.rLeg04c.mirror = true;
        this.rLeg04c.setPos(-7.7F, -0.2F, 0.0F);
        ...
        this.rLeg01c = new ModelPart(this, 43, 32);
        this.rLeg01c.mirror = true;
        this.rLeg01c.setPos(-7.7F, -0.2F, 0.0F);
        ...
        this.rLeg04a = new ModelPart(this, 41, 42);
        ...
        this.rLeg04b = new ModelPart(this, 42, 26);
        ...
        this.rLeg01d = new ModelPart(this, 49, 38);
        this.rLeg01d.mirror = true;
        this.rLeg01d.setPos(-6.7F, 0.0F, 0.0F);
        ...
        this.lLeg02a = new ModelPart(this, 41, 42);
        ...
        this.lLeg01FurB = new ModelPart(this, 0, 42);
        this.lLeg01FurB.setPos(1.0F, -0.3F, 0.2F);
        this.lLeg01FurB.addBox(0.0F, -0.7F, -1.5F, 4, 2, 3, 0.0F);
        this.setRotateAngle(this.lLeg01FurB, 0.0F, 0.0F, -0.4553564018453205F);
        this.lLeg04b = new ModelPart(this, 42, 26);
        ...
        this.lLeg03b = new ModelPart(this, 42, 26);
        ...
        this.rLeg04FurA = new ModelPart(this, 0, 36);
        this.rLeg04FurA.mirror = true;
        this.rLeg04FurA.setPos(-2.6F, -0.2F, 0.2F);
        ...
        this.lPedipalp01 = new ModelPart(this, 29, 12);
        ...
        this.lFang02 = new ModelPart(this, 58, 20);
        ...
        this.rLeg01b = new ModelPart(this, 42, 26);
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.head.yRot = getHeadYaw(entity) * 0.017453292F;
        this.head.xRot = (float) Math.toRadians(getHeadPitch(entity)) * 0.017453292F;
        ...
        float f3 = -(Mth.cos(newLimbSwing * 0.6662F * 2.0F + 0.0F) * 0.4F) * limbSwingAmount;
        float f4 = -(Mth.cos(newLimbSwing * 0.6662F * 2.0F + (float) Math.PI) * 0.4F) * limbSwingAmount;
        float f5 = -(Mth.cos(newLimbSwing * 0.6662F * 2.0F + (float) Math.PI / 2F) * 0.4F) * limbSwingAmount;
        float f6 = -(Mth.cos(newLimbSwing * 0.6662F * 2.0F + (float) Math.PI * 3F / 2F) * 0.4F) * limbSwingAmount;
        float f7 = Math.abs(Mth.sin(newLimbSwing * 0.6662F + 0.0F) * 0.4F) * limbSwingAmount;
        float f8 = Math.abs(Mth.sin(newLimbSwing * 0.6662F + (float) Math.PI) * 0.4F) * limbSwingAmount;
        float f9 = Math.abs(Mth.sin(newLimbSwing * 0.6662F + (float) Math.PI / 2F) * 0.4F) * limbSwingAmount;
        float f10 = Math.abs(Mth.sin(newLimbSwing * 0.6662F + (float) Math.PI * 3F / 2F) * 0.4F) * limbSwingAmount;
