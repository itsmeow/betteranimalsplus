...
public class ModelGoat<T extends LivingEntity> extends ModelBetterAnimals<T> {
    ...
    public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.lLeg01.xRot = MathHelper.cos(limbSwing * 0.8665F + (float) Math.PI) * swingModifier * limbSwingAmount - 0.2792526803190927F;
		this.rLeg01.xRot = MathHelper.cos(limbSwing * 0.8665F) * swingModifier * limbSwingAmount - 0.2792526803190927F;
		this.lArm01.xRot = MathHelper.cos(limbSwing * 0.8665F) * swingModifier * limbSwingAmount + 0.08726646259971647F;
		this.rArm01.xRot = MathHelper.cos(limbSwing * 0.8665F + (float) Math.PI) * swingModifier * limbSwingAmount + 0.08726646259971647F;
