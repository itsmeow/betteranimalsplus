...
public class ModelOctopus<T extends EntityOctopus> extends EntityModel<T> {
    ...
    public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        if(entityIn.isInWaterOrBubble() && (!entityIn.isAboveBlock() || entityIn.getDeltaMovement().length() > 0.01)) {
            ...
            this.setGroundPose();
            this.lTentacle01a.yRot -= MathHelper.sin(limbSwing) * limbSwingAmount / 2F;
            this.lTentacle02a.yRot -= MathHelper.sin(limbSwing) * limbSwingAmount / 2F;
            this.lTentacle03a.yRot += MathHelper.sin(limbSwing) * limbSwingAmount / 2F;
            this.lTentacle04a.yRot += MathHelper.sin(limbSwing) * limbSwingAmount / 2F;
            this.rTentacle01a.yRot -= MathHelper.sin(limbSwing) * limbSwingAmount / 2F;
            this.rTentacle02a.yRot -= MathHelper.sin(limbSwing) * limbSwingAmount / 2F;
            this.rTentacle03a.yRot += MathHelper.sin(limbSwing) * limbSwingAmount / 2F;
            this.rTentacle04a.yRot += MathHelper.sin(limbSwing) * limbSwingAmount / 2F;
        }
    }
