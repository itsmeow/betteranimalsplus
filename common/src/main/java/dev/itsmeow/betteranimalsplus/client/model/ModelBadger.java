...
public class ModelBadger<T extends LivingEntity> extends EntityModel<T> {
    ...
    public ModelPart bellyFloof;
    public ModelPart neck;
    public ModelPart lArm01;
    public ModelPart rArm01;
    public ModelPart chestFloof;
    public ModelPart head;
    public ModelPart neckFloof;
    ...
    public ModelBadger() {
        ...
        this.head = new ModelPart(this, 23, 42);
        this.head.setPos(0.0F, -0.2F, -4.9F);
        this.head.addBox(-3.0F, -3.0F, -5.0F, 6, 5, 5, 0.0F);
        this.setRotateAngle(head, 0.31869712141416456F, 0.0F, 0.0F);
        this.tail02Floof = new ModelPart(this, 30, 95);
        this.tail02Floof.setPos(-0.5F, 1.1F, 0.0F);
    ...
    public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.lLeg01.xRot = Mth.sin(limbSwing * 0.8665F + (float) Math.PI) * 1.5F * limbSwingAmount;
        this.rLeg01.xRot = Mth.cos(limbSwing * 0.8665F) * 1.5F * limbSwingAmount;
        this.lArm01.xRot = Mth.sin(limbSwing * 0.8665F) * 1.5F * limbSwingAmount + 0.22759093446006054F;
        this.rArm01.xRot = Mth.cos(limbSwing * 0.8665F + (float) Math.PI) * 1.5F * limbSwingAmount + 0.22759093446006054F;
    }
