...
public class ModelBadger<T extends LivingEntity> extends EntityModel<T> {
    ...
    public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.lLeg01.xRot = MathHelper.sin(limbSwing * 0.8665F + (float) Math.PI) * 1.5F * limbSwingAmount;
        this.rLeg01.xRot = MathHelper.cos(limbSwing * 0.8665F) * 1.5F * limbSwingAmount;
        this.lArm01.xRot = MathHelper.sin(limbSwing * 0.8665F) * 1.5F * limbSwingAmount + 0.22759093446006054F;
        this.rArm01.xRot = MathHelper.cos(limbSwing * 0.8665F + (float) Math.PI) * 1.5F * limbSwingAmount + 0.22759093446006054F;
    }
