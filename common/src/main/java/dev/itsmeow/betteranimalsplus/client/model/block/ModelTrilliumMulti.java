 ...
 */
public class ModelTrilliumMulti<T extends Entity> extends ModelBAP<T> {
    ...
    public ModelTrilliumMulti(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition stem01 = partdefinition.addOrReplaceChild("stem01", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(2.3F, 24.0F, -5.1F));
        PartDefinition stem02 = partdefinition.addOrReplaceChild("stem02", CubeListBuilder.create().texOffs(0, 5).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(2.3F, 22.1F, -5.1F));
        PartDefinition stem03 = partdefinition.addOrReplaceChild("stem03", CubeListBuilder.create().texOffs(0, 11).addBox(-0.5F, -6.1F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(2.3F, 19.4F, -5.1F));
        PartDefinition stem04 = partdefinition.addOrReplaceChild("stem04", CubeListBuilder.create().texOffs(0, 19).addBox(-1.0F, -1.7F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(2.3F, 13.4F, -5.1F));
        ...
        PartDefinition stem05 = partdefinition.addOrReplaceChild("stem05", CubeListBuilder.create().texOffs(0, 25).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(2.3F, 12.0F, -5.1F));
        ...
        PartDefinition stem02_1 = partdefinition.addOrReplaceChild("stem02_1", CubeListBuilder.create().texOffs(0, 5).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, 24.3F, 3.9F, 0.0F, -1.1221F, -0.0911F));
        PartDefinition stem03_1 = partdefinition.addOrReplaceChild("stem03_1", CubeListBuilder.create().texOffs(0, 11).addBox(-0.5F, -6.1F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.2F, 22.2F, 3.9F, 0.0F, -1.1221F, -0.0911F));
        PartDefinition stem04_1 = partdefinition.addOrReplaceChild("stem04_1", CubeListBuilder.create().texOffs(0, 19).addBox(-1.0F, -1.7F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.7F, 17.1F, 3.9F, 0.0F, -1.1221F, -0.0911F));
        ...
        PartDefinition stem05_1 = partdefinition.addOrReplaceChild("stem05_1", CubeListBuilder.create().texOffs(0, 25).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.8F, 15.9F, 3.9F, 0.0F, -1.1221F, -0.0911F));
