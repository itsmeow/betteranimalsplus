...
public class ModelReindeer<T extends LivingEntity> extends EntityModel<T> {
    ...
    public ModelReindeer() {
        this.texWidth = 128;
        this.texHeight = 64;
        this.lHindHoof = new ModelPart(this, 32, 12);
        this.lHindHoof.setPos(-0.0F, 7.1F, 0.3F);
        this.lHindHoof.addBox(-1.5F, 0.0F, -2.4F, 3, 2, 3, 0.0F);
        this.mane02 = new ModelPart(this, 20, 50);
        this.mane02.setPos(0.0F, 1.5F, -2.2F);
        ...
        this.rHindLeg01.setPos(-2.5F, -1.1F, 3.3F);
        ...
        this.bodyFur = new ModelPart(this, 94, 52);
        this.bodyFur.setPos(0.0F, 5.3F, 1.3F);
        ...
        this.lHindLeg03.setPos(0.1F, 6.4F, 0.5F);
        ...
        this.tail = new ModelPart(this, 33, 0);
        this.tail.setPos(0.0F, -2.7F, 5.1F);
        ...
        this.body.setPos(0.0F, 6.5F, -9.2F);
        ...
        this.rForeleg01.setPos(-3.1F, 0.6F, 2.3F);
        ...
        this.rHindLeg03.setPos(-0.1F, 6.4F, 0.5F);
        ...
        this.mane01.setPos(0.0F, 1.5F, -4.3F);
        ...
        this.rHindHoof = new ModelPart(this, 32, 12);
        this.rHindHoof.mirror = true;
        this.rHindHoof.setPos(-0.0F, 7.1F, 0.3F);
        ...
        this.lForeleg01.setPos(3.1F, 0.6F, 2.3F);
        ...
        this.rForeHoof = new ModelPart(this, 32, 12);
        this.rForeHoof.mirror = true;
        this.rForeHoof.setPos(-0.0F, 8.3F, 0.3F);
        ...
        this.mane03.setPos(0.0F, 1.7F, -4.9F);
        ...
        this.ass = new ModelPart(this, 0, 35);
        this.ass.setPos(0.0F, -0.3F, 12.3F);
        ...
        this.lHindLeg01.setPos(2.5F, -1.1F, 3.3F);
        ...
        this.lForeleg03.setPos(0.0F, 2.7F, 0.0F);
        ...
        this.mane04.setPos(0.0F, 1.8F, -3.1F);
    ...
    public void prepareMobModel(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        float f = ModelReindeer.updateReindeerRotation(entitylivingbaseIn.yBodyRotO, entitylivingbaseIn.yBodyRot, partialTickTime);
        float f1 = ModelReindeer.updateReindeerRotation(entitylivingbaseIn.yHeadRotO, entitylivingbaseIn.yHeadRot, partialTickTime);
        float f2 = entitylivingbaseIn.xRotO + (entitylivingbaseIn.xRot - entitylivingbaseIn.xRotO) * partialTickTime;
        float f3 = f1 - f;
        ...
        this.chest.xRot = f6 * (0.2617994F + f4) + f5 * 2.1816616F + (1.0F - Math.max(f6, f5)) * (0.5235988F + f4) - (float) Math.toRadians(55);
        this.snout.xRot = -0.09424778F * f8;
        this.lowerJaw.xRot = 0.15707964F * f8;
        this.chest.yRot = f6 * f3 * 0.017453292F + (1.0F - Math.max(f6, f5)) * f16;

        float f9 = entitylivingbaseIn.tickCount + partialTickTime;
