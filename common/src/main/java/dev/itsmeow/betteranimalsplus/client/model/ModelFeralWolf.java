...
public class ModelFeralWolf<T extends LivingEntity> extends ModelBetterAnimals<T> {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (!sit) {
            ...
            this.lHindLeg01.xRot = Mth.cos(limbSwing * 0.8665F + (float) Math.PI) * swingModifier * limbSwingAmount - 0.22759093446006054F;
            this.rHindLeg01.xRot = Mth.cos(limbSwing * 0.8665F) * swingModifier * limbSwingAmount - 0.22759093446006054F;
            this.lForeleg01.xRot = Mth.cos(limbSwing * 0.8665F) * swingModifier * limbSwingAmount + 0.22759093446006054F;
            this.rForeleg01.xRot = Mth.cos(limbSwing * 0.8665F + (float) Math.PI) * swingModifier * limbSwingAmount + 0.22759093446006054F;
        }
    }
