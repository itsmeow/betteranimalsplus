...
public class ModelSongbird<T extends LivingEntity> extends EntityModel<T> {
    ...
    public ModelSongbird() {
        ...
        this.lWing03.setPos(5.0F, 0.0F, 0.0F);
        ...
        this.lTailFeather03.setPos(1.1F, 1.0F, 3.5F);
        ...
        this.lWing02.setPos(4.0F, 0.0F, -1.1F);
        ...
        this.rLeg02.setPos(0.0F, 2.6F, 0.0F);
        ...
        this.lTailFeather01.setPos(0.7F, 0.7F, 5.2F);
        ...
        this.rTailFeather03.setPos(-1.1F, 1.0F, 3.5F);
        ...
        this.rTailFeather01.setPos(-0.7F, 0.7F, 5.2F);
        ...
        this.rWing03.setPos(-5.0F, 0.0F, 0.0F);
        ...
        this.rLeg01.setPos(-1.7F, 2.5F, 2.2F);
        ...
        this.rFoot.setPos(0.0F, 2.9F, 0.0F);
        ...
        this.tailBase.setPos(0.0F, -0.9F, 4.3F);
        ...
        this.rTailFeather02.setPos(-1.4F, 0.9F, 4.4F);
        ...
        this.tailCoverts.setPos(0.0F, -0.9F, -0.9F);
        ...
        this.lLeg01.setPos(1.7F, 2.5F, 2.2F);
        ...
        this.lFoot.setPos(0.0F, 3.2F, 0.0F);
        ...
        this.lTailFeather02.setPos(1.4F, 0.9F, 4.4F);
    ...
    public void setupAnim(T entity, float f, float f1, float f2, float f3, float f4) {
        if (entity instanceof EntitySongbird) {
            ...
            if (bird.isFlying()) {
                ...
                this.rWing01.zRot = MathHelper.cos(f2) * (float) Math.PI / 5F;
                ...
                this.rLeg01.xRot = MathHelper.cos(f * 0.6662F) * 1.4F * f1 / e + 0.2617993877991494F;
                this.lLeg01.xRot = MathHelper.cos(f * 0.6662F + (float) Math.PI) * 1.4F * f1 / e + 0.2617993877991494F;
                show = true;
            }
