...
public class ModelBear<T extends EntityBear> extends ModelBetterAnimals<T> {
    ...
    public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.lArm01.xRot = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount + 0.18203784098300857F;
        this.rArm01.xRot = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount + 0.18203784098300857F;
        this.rLeg01.xRot = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount - 0.136659280431156F;
        this.lLeg01.xRot = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount - 0.136659280431156F;
        ...
        if(f1 != 0) {
            ...
            this.lArm01.xRot = MathHelper.sin(ageInTicks * 0.5F) * 0.9F + 0.18203784098300857F;
            this.rArm01.xRot = -MathHelper.sin(ageInTicks * 0.5F) * 0.9F + 0.18203784098300857F;
            if(!Minecraft.getInstance().isPaused()) {
                this.neck.xRot += off;
            }
        } else {
