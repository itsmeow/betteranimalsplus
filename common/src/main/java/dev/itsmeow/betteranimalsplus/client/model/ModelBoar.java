...
public class ModelBoar<T extends LivingEntity> extends EntityModel<T> {
    ...
    public void setupAnim(T entity, float f, float f1, float f2, float f3, float f4) {
        this.lArm01.xRot = MathHelper.cos(f * 0.6662F) * 1.4F * f1;
        this.rArm01.xRot = MathHelper.cos(f * 0.6662F + (float) Math.PI) * 1.4F * f1;
        this.rLeg01.xRot = MathHelper.cos(f * 0.6662F) * 1.4F * f1;
        this.lLeg01.xRot = MathHelper.cos(f * 0.6662F + (float) Math.PI) * 1.4F * f1;
