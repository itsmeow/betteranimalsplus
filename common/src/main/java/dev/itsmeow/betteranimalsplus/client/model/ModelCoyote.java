...
public class ModelCoyote<T extends LivingEntity> extends ModelBetterAnimals<T> {
    ...
    public void prepareMobModel(T entity, float limbSwing, float limbSwingAmount,
        ...
        if(entity instanceof EntityFeralWolf) {
            ...
            if (!entityferalwolf.isTame()) {
                ...
                this.tail01.yRot = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
            }
        }
    }
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.lHindLeg01.xRot = MathHelper.cos(newLimbSwing * 0.8665F + (float) Math.PI) * swingModifier * limbSwingAmount - 0.22759093446006054F;
        this.rHindLeg01.xRot = MathHelper.cos(newLimbSwing * 0.8665F) * swingModifier * limbSwingAmount  - 0.22759093446006054F;
        this.lArm01.xRot = MathHelper.cos(newLimbSwing * 0.8665F) * swingModifier * limbSwingAmount + 0.22759093446006054F;
        this.rArm01.xRot = MathHelper.cos(newLimbSwing * 0.8665F + (float) Math.PI) * swingModifier * limbSwingAmount + 0.22759093446006054F;
        this.neck.xRot = -0.6F;
