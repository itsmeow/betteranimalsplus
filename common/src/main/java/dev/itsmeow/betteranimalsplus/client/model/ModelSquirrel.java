...
public class ModelSquirrel<T extends LivingEntity> extends EntityModel<T> {
    ...
    public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.lArm01.xRot = Mth.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount - 0.20943951023931953F;
        this.rArm01.xRot = Mth.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount - 0.20943951023931953F;
        this.rLeg01.xRot = Mth.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount - 0.17453292519943295F;
        this.lLeg01.xRot = Mth.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount - 0.17453292519943295F;
        this.tail01.xRot = Mth.sin(limbSwing * 0.2F) * limbSwingAmount - (float) Math.toRadians(30);
