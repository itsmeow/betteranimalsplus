...
public class ModelBullShark extends EntityModel<EntityShark> {
    ...
    public ModelBullShark() {
        ...
        this.snout.setPos(0.0F, -2.5F, -7.9F);
    ...
    public static void animate(EntityShark entity, float ageInTicks, ModelRenderer body, ModelRenderer tail00, ModelRenderer tail01, ModelRenderer tail02, ModelRenderer lowerJaw) {
        ...
        tail00.yRot = MathHelper.cos(ageInTicks * 0.25F) * 0.05F * motionFactor;
        tail01.yRot = MathHelper.cos(ageInTicks * 0.25F) * 0.05F * motionFactor;
        tail02.yRot = MathHelper.cos(ageInTicks * 0.25F) * 0.05F * motionFactor;
