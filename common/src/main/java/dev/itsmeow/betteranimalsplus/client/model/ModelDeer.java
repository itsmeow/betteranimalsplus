...
public class ModelDeer<T extends LivingEntity> extends ModelBetterAnimals<T> {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.lForeleg01.xRot = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount + 0.136659280431156F;
        this.rForeleg01.xRot = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount + 0.136659280431156F;
