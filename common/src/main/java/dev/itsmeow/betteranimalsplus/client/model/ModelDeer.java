...
public class ModelDeer<T extends LivingEntity> extends ModelBetterAnimals<T> {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.lForeleg01.xRot = Mth.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount + 0.136659280431156F;
        this.rForeleg01.xRot = Mth.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount + 0.136659280431156F;
        ...
        if (entity instanceof Mob) {
            this.chest.xRot = getHeadPitch(entity) * 0.017453292F - 13;
            this.chest.yRot = getHeadYaw(entity) * 0.017453292F * 0.5F;
        }
