...
public class ModelMoose<T extends LivingEntity> extends EntityModel<T> {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.lForeleg01.xRot = Mth.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount + 0.19198621771937624F;
        this.rForeleg01.xRot = Mth.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount + 0.19198621771937624F;
        this.rHindLeg01.xRot = Mth.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount - 0.22759093446006054F;
        this.lHindLeg01.xRot = Mth.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount - 0.22759093446006054F;
