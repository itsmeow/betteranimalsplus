...
public class ModTileEntities {
    ...
    public static final RegistryObject<TileEntityType<TileEntityTrillium>> TRILLIUM_TYPE = r("trilliumtileentity", () -> TileEntityType.Builder.of(TileEntityTrillium::new, ModBlocks.TRILLIUM.get()).build(null));
